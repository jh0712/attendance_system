...
use Modules\QuiryBuilder\Contracts\FilterContract;
use Modules\QuiryBuilder\Exceptions\UnsupportedFilter;
use Modules\QuiryBuilder\Traits\HasElements;
use Modules\QuiryBuilder\Traits\HasOperators;

class FilterBroker implements FilterContract
{
    use HasElements,HasOperators;
     ...
     * @var string
     */
    protected $namespace = 'Modules\QuiryBuilder\Filters';
    ...
    {
        $className = studly_case($input) . 'Filter';
